                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="height: 70px;" class="text-center">
                                        ...
                                        @if (!empty($data->getProcurementGroup) && !empty($data->getProcurementGroup->tandatangan))
                                            <img src="{{ asset('storage/upload/tandatangan/' . $data->getProcurementGroup->tandatangan) }}"
                                                alt="TTD" style="max-width:110px; max-height:60px;">
                                        @endif
                                    </td>
                                </tr>
