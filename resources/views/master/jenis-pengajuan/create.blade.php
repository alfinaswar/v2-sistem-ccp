        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="card-title mb-0">Formulir Tambah Jenis Pengajuan</h4>
                    <p class="card-text mb-0">
                        Silakan isi data jenis pengajuan baru di bawah ini.
                    </p>
                </div>
                <div class="card-body">
                    <form action="{{ route('jenis-pengajuan.store') }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="Nama"
                                    ...
                                    placeholder="Nama Jenis Pengajuan" value="{{ old('Nama') }}">
                                @error('Nama')
