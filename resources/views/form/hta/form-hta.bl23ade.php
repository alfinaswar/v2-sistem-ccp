                                    ...
                                    <div class="mb-3">
                                        <div class="row mb-2 align-items-center">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <input type="hidden" name="NamaVendor[]"
                                                    value="{{ $vendor->getNamaVendor->id ?? '-' }}" readonly>
                                                <input type="hidden" name="VendorKe[]" value="{{ $vnIdx + 1 ?? '-' }}"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="row mb-2 align-items-center">
                                        ...
                                        <tbody>
                                            @foreach ($Parameter->getForm->Parameter as $i => $param)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea class="form-control" name="Deskripsi[]" rows="2" placeholder="Tulis deskripsi penilaian..."></textarea>
                                                    </td>
                                                    <td>
    ...
    <script>
        function calcSubtotalsAndTotal(vendorId) {
            ...
            for (let i = 0; i < {{ $rowCount }}; i++) {
                ...
                document.getElementById(vendorId + '-subtotal-' + i).textContent = subtotal;
            ...
            document.getElementById(vendorId + '-total').textContent = total;
        }
        ...
        // Ini untuk update semua total ketika halaman dimuat (jika ada value)
